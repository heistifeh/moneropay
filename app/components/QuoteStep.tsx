...
export default function QuoteStep({ onNext }: { onNext: () => void }) {
  const { getQuote, loading, error } = useQuoteStore();
  ...
  async function handleCreate() {
    ...
    onNext(); // will navigate after Phase 2 wires `getQuote` to backend
  }

  return (
    <div>
      <button disabled={loading} onClick={handleCreate}>Get quote</button>
