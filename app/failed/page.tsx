...
export default function FailedPage() {
  ...
  // If no active quote, bounce back home
  useEffect(() => {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col items-center justify-center p-6">
      ...
      >
        <h1 className="text-2xl font-semibold text-rose-600">Exchange Failed ❌</h1>
        <p className="mt-2 text-sm text-zinc-600">
          Unfortunately, your {quote?.base_symbol} → {quote?.quote_symbol} exchange did not complete.
        </p>
